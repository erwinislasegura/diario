...
<article class="video-story">
    ...
    <div class="shell">
        <nav class="breadcrumbs breadcrumbs-dark" aria-label="Migas de pan"><a href="<?= url('/') ?>">Inicio</a><span>›</span><a href="<?= url('/videos') ?>">Pulso Angelino TV</a><span>›</span><span><?= e($video['format']) ?></span></nav>
        <header class="video-story-heading">
            <div><small>PULSO ANGELINO TV · <?= e($video['format']) ?></small><h1><?= e($video['title']) ?></h1></div>
        ...
        <div class="video-stage">
            <div class="video-stage-bar"><span><i></i> REPRODUCIENDO EN PULSO ANGELINO TV</span><b><?= e($video['commune']) ?></b></div>
