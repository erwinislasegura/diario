...
final class SiteController extends Controller
{
    ...
    public function search(): void {
        ...
        Analytics::record('/buscar','search',null,$query!==''?'Búsqueda: '.$query:'Búsqueda');
        $this->render('site/search',['title'=>$query!==''?'Resultados para “'.$query.'”':'Buscar noticias','query'=>$query,'posts'=>$posts,'categories'=>Category::topLevel(),'metaDescription'=>'Busca noticias, actualidad y contenidos de Pulso Angelino.']);
    }
